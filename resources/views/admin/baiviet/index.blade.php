        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header justify-content-between">
                    ...
                    <x-link :href="route('admin.blog.baiviet.create')" class="btn btn-primary">
                        <i class="ti ti-plus"></i>
                        @lang('add')
                    </x-link>
                </div>
                <div class="card-body">
                    <x-form id="formMultiple" :action="route('admin.blog.baiviet.action_multiple_record')" type="post" :validate="true">
