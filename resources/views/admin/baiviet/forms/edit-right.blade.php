<div class="col-12 col-md-3">
    <div class="card mb-3">
        ...
        <div class="card-body p-2 d-flex justify-content-between">
            ...
            <x-button.modal-delete data-route="{{ route('admin.blog.baiviet.delete', $post->id) }}" :title="__('delete')" />
        </div>
    </div>
    <div class="card mb-3">
        <div class="card-header">
        ...
        <div class="card-body p-2 wrap-list-checkbox">
            @foreach ($categories as $category)
                <x-input-checkbox :checked="$post->danhmuc->pluck('id')->toArray()" :depth="$category->depth" name="categories_id[]" :label="$category->name" :value="$category->id"/>
            @endforeach
        </div>
    </div>
    <div class="card mb-3">
